...
export const APP_PORT: number = env.find((e) => e.name === "APP_PORT")?.value as number;

export const APP_DATABASE_URI: string = env.find((e) => e.name === "APP_DATASOURCE_URI")?.value as string;
